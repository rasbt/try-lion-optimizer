...
class LightningModel(L.LightningModule):
    ...
    def configure_optimizers(self):
        opt = Lion(model.parameters(), lr=self.learning_rate, weight_decay=1e-2)
        return opt
...
if __name__ == "__main__":
    ...
    num_epochs = 10
    lightning_model = LightningModel(model, learning_rate=1e-5)
    ...
    logger = CSVLogger(save_dir="logs/", name="lion")
