...
class LightningModel(L.LightningModule):
    ...
    def configure_optimizers(self):
        opt = torch.optim.SGD(self.parameters(), momentum=0.0, lr=self.learning_rate)
...
if __name__ == "__main__":
    ...
    lightning_model = LightningModel(model, learning_rate=0.05, cosine_t_max=num_steps)
    ...
    logger = CSVLogger(save_dir="logs/", name="sgd-cosine")
